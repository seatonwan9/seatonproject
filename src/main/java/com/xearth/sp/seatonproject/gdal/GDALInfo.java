...
public class GDALInfo {
    ...
    public static void gdalInfo(String[] args) {
        Dataset hDataset;
        Band hBand;
        int i, iBand;
    ...
    public static boolean GDALInfoReportCorner(Dataset hDataset, String corner_name, double x, double y) {
    ...
    public static void main(String[] args) {
        String[] arr = new String[]{"D:/issue/CHINA_PRE_202106070800/CHINA_3.tif"};
        gdalInfo(arr);
    }
}
